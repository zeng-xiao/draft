...
namespace std {
  ...
  public:
    ...
    // \ref{func.wrap.move.ctor}, constructors and destructor
...
\begin{note}
Such small-object optimization can only be applied to types \tcode{T}
for which \tcode{is_nothrow_move_constructible_v<T>} is \tcode{true}.
\end{note}

\rSec4[func.wrap.move.ctor]{Constructors and destructor}
...
\tcode{F} is the type of that target object.
\end{itemdescr}
